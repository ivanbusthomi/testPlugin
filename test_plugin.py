...
class testPlugin:
    ...
    def initGui(self):
        ...
        #self.tool = NearestPlaceTool(self.iface.mapCanvas())
        #self.tool = mouseEventTool(self.iface.mapCanvas())
    ...
    def run(self):
        ...
        QObject.connect(self.dlg.buttonHelp, SIGNAL("clicked()"), self.showhelp)                  # call the show help dialog function
